...
class ChatRequest(BaseModel):
    ...
    model: str = "ollama/llama2"  # Default model to use with Ollama

# Ollama client helper
def get_ollama_response(prompt, model="ollama/llama2"):
    try:
...
# CrewAI setup
def setup_crew(query, model_name="ollama/llama2"):
...
async def get_info():
    ...
    return {
        ...
        "version": "1.0.0",
        "models_available": ["ollama/llama2", "ollama/mistral", "ollama/phi", "ollama/gemma"]
    }
    ...
    try:
        while True:
            ...
            try:
                ...
                model = request_data.get("model", "ollama/llama2")
